...
export default function Index() {
  const missionStatement =
    "«Саранская красавица» — это не просто конкурс красоты. Это ежегодный городской праздник, который объединяет молодых талантливых женщин, семьи и всё местное сообщество. Мы создаём платформу для вдохновения, самовыражения и признания. Партнёрство с нашим событием — это прямой диалог с активной, лояльной и платёжеспособной аудиторией Саранска и всей республики Мордовия."
  ...
  const timelineEntries = [
    {
      ...
      description:
        "Более 2 000 зрителей на площадке и 50 000+ просмотров в онлайне. Женщины и мужчины 20–45 лет, семьи с детьми, представители бизнеса и городской культурной элиты. Это лояльная, вовлечённая аудитория с высоким уровнем доверия к брендам-партнёрам мероприятия.",
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-gray-900 border-2 border-yellow-400 p-8 rounded-none relative text-white"
              style={{ clipPath: "polygon(20px 0%, 100% 0%, 100% calc(100% - 20px), calc(100% - 20px) 100%, 0 100%, 0 20px)" }}
            >
