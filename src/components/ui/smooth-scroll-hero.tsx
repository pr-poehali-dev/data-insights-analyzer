...
const SmoothScrollHero: React.FC<SmoothScrollHeroProps> = ({ desktopImage, mobileImage }) => {
  return (
    <div className="relative w-full min-h-screen overflow-hidden" style={{ backgroundColor: "#0d2418" }}>
      {/* Gold top border */}
        ...
        <div className="text-center text-white max-w-4xl mx-auto px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
            {[
              ...
              { icon: Calendar, value: "11 июля", label: "Дата проведения" },
              { icon: Trophy, value: "3", label: "Года на площадке" },
            ].map((s) => (
