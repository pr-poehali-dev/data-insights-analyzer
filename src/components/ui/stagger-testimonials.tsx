...
const testimonials = [
  ...
  },
  {
    id: 3,
    testimonial:
      "Нас упомянули на сайте «Столица С» — такого охвата мы не ожидали. Организаторы сработали чётко и профессионально. Узнаваемость бренда НЕВА после мероприятия выросла ощутимо. Однозначно рекомендуем.",
    by: "Щербаков К.В.",
